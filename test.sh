...
exec_test 'echo $PWD; echo $OLDPWD; cd ../../../..; pwd; echo $PWD; echo $OLDPWD' #OK
exec_test 'export HELLO\\WORLD' #OK
exec_test 'export N\\T' #OK
exec_test 'export bO_nJq123o__1ju_je3134sui__a=a; echo $bO_nJq123o__1ju_je3134sui__a' #OK
exec_test 'export A==a; echo $A' #OK
exec_test 'export A=a=a=a=a=a; echo $A' #OK
exec_test 'echo TEST > foo > bar' #OK
exec_test 'echo bar > FILE1 >> FILE2 >> FILE3' #OK
exec_test 'echo >> FILE foo' #OK
exec_test 'echo >> FILE1 foo > FILE2' #OK
...
exec_test 'echo "a\\b"' #OK
#echo "a\\ \ b c\" \'$SHELL\'"#OK
#exec_test "echo \"a\\ \ b c\" \'$SHELL\'\"" #OK
exec_test "echo $\"SHELL\"" #OK
exec_test "echo $\'SHELL\'" #OK
exec_test "/bin/ls" "-l" #OK
#exec_test 'top | grep root' #OK
#exec_test 'cat /dev/random | cat' #OK
exec_test 'ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls'#OK
exec_test '> FILE ; ls > FILE | rev | wc -c >> FILE ; cat FILE ; < INFILE cat' #OK
exec_test 'echo test "" test ""' #OK
exec_test 'echo test '' test ''' #OK
